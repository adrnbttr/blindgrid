...
MESSAGES: dict[str, str] = {
    ...
    "config.init.help": "Legt eine Konfigurationsdatei aus dem mitgelieferten Beispiel an.",
    "config.show.help": "Zeigt die aktive Konfiguration.",
    "config.edit.help": "Geht die Konfigurationswerte einzeln durch.",
    "lottery.list.help": "Zeigt alle konfigurierten Lotterien.",
    "lottery.add.help": "Fügt eine Lotterie hinzu oder ersetzt die gleichnamige.",
    "player.add.help": "Fügt eine Person hinzu oder aktualisiert sie, wenn der Name schon da ist.",
    "player.list.help": "Zeigt, wer spielt, mit Grenze und Vorlieben.",
